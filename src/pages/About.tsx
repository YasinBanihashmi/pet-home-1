...
function About() {
  return (
    ...
    <div className="of-site-mask"></div>
    
    <div className="off-canvas-wrap ">
            <div className="close-off-canvas-wrap">
                <a href="#" id="of-close-off-canvas">
                    <svg className="mt-3" width="12" height="12" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="off-canvas-inner">
                <div id="of-mobile-nav" className="mobile-menu-wrap">
                        <div className="d-block text-center my-3">
                            <a href="Index.html" className="current py-2">
    ...
    <header className="main_header wide_header">
            <div className="header_container">
                <div className="menu_wrapper menu_sticky header-btop">
                    <div className="container p_relative h86">

                        <div id="navigation" className="of-drop-down of-main-menu" role="navigation">
                            <ul className="menu">
                                <li>
                                    <a href="Index.html" className="current py-2">
                                        <img src="Img/logo.svg" />
                        ...
                        <div className="m_login d-flex">
                            <div className="shoping-cart radius30">
                                <a href="cart.html">
                            ...
                            <div className="login px-4 py-2 radius55 d-flex align-items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a className="mr-2" href="login.html">ثبت نام | ورود</a>
                            </div>
                        </div>

                        <div className="is-show mobile-nav-button">
                            <a id="of-trigger" className="icon-wrap" href="#">
                        ...
                        <div className="logo-mobile d-none">
                            <a href="Index.html" className="current py-2">
                                <img src="Img/logo.svg" />
                            </a>
                        </div> 
    ...
    <section className="container-fluid bkg p-0">
            <div className="row">
                <div className="col-lg-12 p-0 mb-3">
                    <div className="bg-package d-flex align-items-center justify-content-center">
                        <div className="breadcrumb radius15">
                            <ul className="d-flex align-items-center">
                                ...
                                <li>
                                    <a href="#" className="current">درباره ما</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <section className="container-fluid text-lg-right text-center my-4 mb-5">
                  ...
                  <div className="col-lg-7 pl-lg-5">
                    ...
                    <div className="d-flex align-items-center mb-1">
                        <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className="mr-3">درباره ما</h2>
                    </div>   
                        <p className="mb-3">پت هوم،  سرزمین حیوانات خانگی با محصولات باکیفیت برای پت های شما</p>
                        <h3 className="mt-4 color-orange">سرزمین حیوانات خانگی</h3>
                        <p className="my-4 text-justify">
                            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.
                        </p>

                        <div className="d-flex align-items-center justify-content-between mb-5 d-xs-block">
                            <div className="d-flex flex-row align-items-center">
                            <img src="Img/profile.jpg" className="img-fluid rounded-circle ml-3 pic55" alt="Profile" />                                <div className="py-2">
                                <p className="text-dark bottom_p YekanBakhFaNum-Bold"> امین محمدی</p>
                                <span className="color-orange">مدیریت Pet Home</span>
                                </div>
                            </div>
                            <a className="d-flex align-items-center a-button radius55 py-2 px-4" href="#">
                                <span className="ml-2">بیشتر بخوانید</span>
                                <svg width="12" height="11" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="col-lg-5 d-flex align-items-center ">
                        <img src="Img/about-us.png" className="img-fluid wapp" />
                    </div>
                   </div>
            </div>
    </section>
    
    <section className="container-fluid text-white my-5 p-0">
        <div className="container bg-dark radius45 pt-4">
            <div className="row justify-content-center text-center px-md-5 py-3">

                <div className="col-md-3 col-6 mb-2">
                    <div className="col">
                        <div className="counter">
                            <p className="count-text ">محصولات</p>
                         <h2 className="timer count-title count-number" data-to="61" data-speed="1500"></h2>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-3 col-6 mb-2">
                    <div className="col">
                        <div className="counter">
                            <p className="count-text ">سابقه فعالیت</p>
                         <h2 className="timer count-title count-number" data-to="12" data-speed="1500"></h2>
                        </div>
                    </div>
                ...
                <div className="col-md-3 col-6 mb-2">
                    <div className="col">
                        <div className="counter">
                            <p className="count-text ">مشتریان راضی</p>
                            <span></span>
                         <h2 className="timer count-title count-number" data-to="95" data-speed="1500"></h2>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-3 col-6 mb-2">
                    <div className="col">
                        <div className="counter">
                            <p className="count-text ">اعضای تیم</p>
                            <span></span>
                         <h2 className="timer count-title count-number" data-to="23" data-speed="1500"></h2>
                        </div>
                    </div>
                </div>
    ...
    <section className="text-lg-right text-center my-4">
        <div className="container py-3 p-lg-5">
            <div className="row">

                <div className="col-lg-5 d-lg-block d-none">
                    <img src="Img/dog-b2.png" className="img-fluid wapp" />
                </div>
                ...
                <div className="d-flex align-items-center mb-1">
                    ...
                    <h2 className="mr-3">سوالات متداول</h2>
                </div>  
                ...
                <div id="cstm_collapsible" className="custon_shadw">
                        <button className="collapsible">اصالت و کیفیت غذای پت رو از کجا تشخیص بدم؟</button>
            ...
            <div className="col-lg-12">
                ...
                <div className="row my-5">
                    <div className="col-lg-3 col-md-6 mb-4">
                        <div className="card profile p-3 overlyblog">
                            <img src="Img/profile.jpg">
                        <h3 className="YekanBakhFaNum-Bold">معین حیدری</h3>
                        <p className="YekanBakhFaNum-SemiBold color-orange">مدیرعامل</p>
                        <p className="my-2 fa14">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. </p>
                        <ul>
                    ...
                    <div className="col-lg-3 col-md-6 mb-4">
                        ...
                        <h3 className="YekanBakhFaNum-Bold">سهیل زارعی</h3>
                        <p className="YekanBakhFaNum-SemiBold color-orange">برنامه نویس</p>
                        <p className="my-2 fa14">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. </p>
                        <ul>
                            <svg width="26" height="26" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.9851 32.533C17.9934 32.533 15.1745 31.132 12.9465 24.4309L11.7311 20.785L8.08521 19.5697C1.40099 17.3416 0 14.5228 0 12.531C0 10.5561 1.40099 7.72039 8.08521 5.47544L22.4158 0.698585C25.9942 -0.499848 28.9818 -0.145382 30.8217 1.67759C32.6615 3.50056 33.016 6.50508 31.8176 10.0835L27.0407 24.4141C24.7958 31.132 21.9769 32.533 19.9851 32.533ZM8.87854 7.88919C4.18608 9.45897 2.51502 11.3157 2.51502 12.531C2.51502 13.7463 4.18608 15.603 8.87854 17.1559L13.1321 18.5738C13.5035 18.692 13.8073 18.9958 13.9255 19.3671L15.3433 23.6207C16.8962 28.3132 18.7698 29.9842 19.9851 29.9842C21.2005 29.9842 23.0572 28.3132 24.627 23.6207L29.4038 9.29017C30.2647 6.69075 30.1128 4.56396 29.0156 3.4668C27.9184 2.36964 25.7916 2.23461 23.2091 3.09545L8.87854 7.88919Z" fill="#292D32"/>
                    ...
                    <div className="col-lg-3 col-md-6 mb-4">
                        ...
                        <h3 className="YekanBakhFaNum-Bold">آتوسا صادقی</h3>
                        <p className="YekanBakhFaNum-SemiBold color-orange">طراح گرافیک</p>
                        <p className="my-2 fa14">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. </p>
                        <ul>
                            <svg width="26" height="26" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.9851 32.533C17.9934 32.533 15.1745 31.132 12.9465 24.4309L11.7311 20.785L8.08521 19.5697C1.40099 17.3416 0 14.5228 0 12.531C0 10.5561 1.40099 7.72039 8.08521 5.47544L22.4158 0.698585C25.9942 -0.499848 28.9818 -0.145382 30.8217 1.67759C32.6615 3.50056 33.016 6.50508 31.8176 10.0835L27.0407 24.4141C24.7958 31.132 21.9769 32.533 19.9851 32.533ZM8.87854 7.88919C4.18608 9.45897 2.51502 11.3157 2.51502 12.531C2.51502 13.7463 4.18608 15.603 8.87854 17.1559L13.1321 18.5738C13.5035 18.692 13.8073 18.9958 13.9255 19.3671L15.3433 23.6207C16.8962 28.3132 18.7698 29.9842 19.9851 29.9842C21.2005 29.9842 23.0572 28.3132 24.627 23.6207L29.4038 9.29017C30.2647 6.69075 30.1128 4.56396 29.0156 3.4668C27.9184 2.36964 25.7916 2.23461 23.2091 3.09545L8.87854 7.88919Z" fill="#292D32"/>
                    ...
                    <div className="col-lg-3 col-md-6 mb-4">
                        ...
                        <h3 className="YekanBakhFaNum-Bold">علی عباسی</h3>
                        <p className="YekanBakhFaNum-SemiBold color-orange">سئو</p>
                        <p className="my-2 fa14">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. </p>
                        <ul>
                            <svg width="26" height="26" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.9851 32.533C17.9934 32.533 15.1745 31.132 12.9465 24.4309L11.7311 20.785L8.08521 19.5697C1.40099 17.3416 0 14.5228 0 12.531C0 10.5561 1.40099 7.72039 8.08521 5.47544L22.4158 0.698585C25.9942 -0.499848 28.9818 -0.145382 30.8217 1.67759C32.6615 3.50056 33.016 6.50508 31.8176 10.0835L27.0407 24.4141C24.7958 31.132 21.9769 32.533 19.9851 32.533ZM8.87854 7.88919C4.18608 9.45897 2.51502 11.3157 2.51502 12.531C2.51502 13.7463 4.18608 15.603 8.87854 17.1559L13.1321 18.5738C13.5035 18.692 13.8073 18.9958 13.9255 19.3671L15.3433 23.6207C16.8962 28.3132 18.7698 29.9842 19.9851 29.9842C21.2005 29.9842 23.0572 28.3132 24.627 23.6207L29.4038 9.29017C30.2647 6.69075 30.1128 4.56396 29.0156 3.4668C27.9184 2.36964 25.7916 2.23461 23.2091 3.09545L8.87854 7.88919Z" fill="#292D32"/>
    ...
    <footer className="footer-parent pt-4 pb-4">
        <div className="container footer-wrap">
    
            <div className="row py-3">
    
            <div className="col-lg-5 col-md-6 col-sm-12 px-md-3 mb-4 pl-lg-5">
                <div className="d-flex align-items-center mb-4">
                    <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h2 className="mr-3 color-white">راه های ارتباطی</h2>
                </div>
                   ...
                   <div className="d-flex align-items-center my-3">
                    ...
                    <p className="mr-2">آدرس  : تهران، زعفرانیه، خیابان مقدس اردبیلی، راست چین</p>
                   </div>
                   ...
                   <div className="d-flex justify-content-between">
                    <div className="d-flex align-items-center my-3">
                        ...
                        <p className="mr-2">09123456789</p>
                       </div>
                       <div className="d-flex align-items-center my-3">
                        ...
                        <p className="mr-2">info @ rtl-theme.com</p>
                       </div>
                   </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 mb-4">
                <div className="d-flex align-items-center mb-4">
                    <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h2 className="mr-3 color-white">پیوندها</h2>
                </div>
                <ul className="footer-category text-center">
                    <li>
                        <a href="Index.html">صفحه اصلی</a>
                    </li>
                    <li>
            ...
            <div className="col-lg-4 col-md-6  col-sm-12 mb-4">
                    <div className="d-flex align-items-center mb-4">
                        <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className="mr-3 color-white">ساعت کاری</h2>
                    </div>
                    <div className=" mb-2 text-right">
                   
                        <div className="bg-clock p-4 radius30">
                            <div className="clock-pet px-3 py-2">
                                <p>شنبه - چهارشنبه:</p>
                                <p>8:00 - 15:00</p>
                            </div>
            ...
            <div className="d-flex align-items-center justify-content-between copyright py-3 px-5 radius30">
    
    
                <div className="media-icone d-flex align-items-center">
                ...
                <div className="">
                    <p className="text-center fa14">کلیه حقوق مادی و معنوی این قالب برای توسعه دهندگان آن محفوظ بوده و هرگونه کپی برداری، پیگرد قانونی دارد.</p>
                </div>
        
                <div className="text-left logo-footer">
